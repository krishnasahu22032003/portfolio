        ...
        {gears.map((gear, index) => (
          <motion.div
            ...
            className={`group py-7 ${
              index !== gears.length - 1 ? "border-b border-border" : ""
          ...
          >
            ...
            >
              <div className="flex flex-col items-start gap-1.5 text-left">
                ...
                <h2 className="font-serif text-[19px] font-semibold italic tracking-tight text-foreground transition-opacity duration-300 group-hover:opacity-80">
                  {gear.name}
                </h2>
              ...
              <span className="mt-1 flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-border text-muted-foreground transition-all duration-300 ease-out group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:border-foreground group-hover:text-foreground">
